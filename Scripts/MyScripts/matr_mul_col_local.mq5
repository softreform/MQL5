...
//| input matrices are already generated, the output matrix is initialized to zeros       |
//+------------------------------------------------------------------+
void mulCPUOneCore()
  {
// c-r-cr: 11.544 s 
...
//--- debugging: random checks. 
//--- Multiplication accuracy is checked directly using a few dozen examples 
...
//--- initialize random number generator
   ...
   Print("=======================================");
   Print("1st OCL martices mul:  device = "+i2s(_device)
         +";      ROWS1 = "+i2s(ROWS1)
         +"; COLSROWS = "+i2s(COLSROWS)
         +"; COLS2 = "+i2s(COLS2));
...
//| this generation is not reflected in the runtime calculation      |
...
//+------------------------------------------------------------------+
//| genVal                                                           |
//| one value of the matrix element:                                 |
...
void WriteCLProgram()
  {
   int h=FileOpen("matr_mul_col_local.cl",FILE_WRITE|FILE_TXT|FILE_ANSI);
   FileWrite(h,clSrc);
   FileClose(h);
  }
//+------------------------------------------------------------------+
...
//| destroyOpenCL                                                    |
//+------------------------------------------------------------------+
void destroyOpenCL(int clCtx,int clPrg,int clKrn,
                   int clMemIn1,int clMemIn2,int clMemOut)
  {
