...
CSignalRSI      *EntrySignal;

// TPSL - use child class name
// CTPSLSimple     *TPSL;

// Indicators
CIndicatorRSI    *RSIIndicator;
...
int OnInit() {
  ...
  RSIIndicator = new CIndicatorRSI(InpPeriods, InpAppliedPrice);

  // Set up the signals
  EntrySignal   = new CSignalRSI(InpBuyLevel, InpSellLevel);
