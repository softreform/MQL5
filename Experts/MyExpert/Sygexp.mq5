...
//+------------------------------------------------------------------+
//--- inputs for expert
input string Expert_Title                 ="Sygexp"; // Document name
ulong        Expert_MagicNumber           =9607;     //
...
input double Signal_BearsPower_Weight     =0.5;      // Bears Power(13) Weight [0...1.0]
input int    Signal_BullsPower_PeriodBulls=13;       // Bulls Power(13) Period of calculation
input double Signal_BullsPower_Weight     =0.5;      // Bulls Power(13) Weight [0...1.0]
//--- inputs for money
