...
#include "../snippets/Grid/EmptyCell.mq5"
#include "../snippets/Grid/LabelCell.mq5"
#include "../snippets/Grid/Grid.mq5"
#include "../snippets/Grid/TrendValueCellFactory.mq5"

Grid *grid;

#include "../snippets/Grid/GridBuilder.mq5"
